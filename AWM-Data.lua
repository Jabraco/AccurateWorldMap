...
-- ctrl + f aid: eltheric ocean
  ...
  [315] = { -- Eltheric Ocean Map
    ...
    zoneData = join({
      zoneName = "High Isle",
      zoneDescription = "High Isle is the largest of the Systres Archipelago, and it serves as the center of politics and commerce for the island chain, predominantly from the port city of Gonfalon Bay.",
      zoneID = 2114,
      xN = "0.696",
      yN = "0.660",
      zonePolygonData = {
